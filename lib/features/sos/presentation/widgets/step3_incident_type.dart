    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (emergencyError != null) _errorText(emergencyError!),

          const SizedBox(height: 16),

          // Injury dropdown + error
          CustomDropdownField(
          ...
          if (injuryError != null) _errorText(injuryError!),

          const SizedBox(height: 16),

          // Severity dropdown + error
          CustomDropdownField(
          ...
          if (severityError != null) _errorText(severityError!),
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xffE62415),
                  elevation: 0,
