            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 16,
                  height: 1.7,
                  color: AppColors.grey.withOpacity(.95),
                ),
              ),
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 14,
                              height: 1.6,
                              color: AppColors.black.withOpacity(.72),
                            ),
                          ),
                        ],
                      ),
              ...
              /// Bluetooth Button — دايماً موجود، بس مفعّل بس لو مفيش نت
              SizedBox(
                width: double.infinity,
                height: 56,
                  ...
                  onPressed: status == 'pending_connection'
                      ? () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  BluetoothSearchScreen(requestId: requestId),
                            ),
                          );
                        }
                      : null,
